...
En esta sección se muestra cómo incluir formatos de manera local por medio de "ambientes" de latex. Esta forma de dar formato tiene dos ventajas.
...
Por último, revisemos algunos de los comandos más útiles en latex.
...
Un ejemplo de como queda el uso de ambientes lo pueden consultar ()[]
# Github
